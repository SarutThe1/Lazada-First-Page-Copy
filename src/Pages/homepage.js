...
const homepage = () => {
  ...
  return (
    <>
      ...
      >
        <div className="centered">
          <div className='side-menu'  style={{ zIndex: "2" }}>
            <SideMenu />
          </div>
        ...
        <div className="centered">
          ...
          >
            <div className="col-md-3">
              ...
              <p className="content">
                As online shopping becoming more <br /> prevalent now, Lazada
                Thai is always <br />
                striving to keep up with what the
                <br /> consumers want and need. We are <br />
                making every effort to achieve maximum <br />
                customer satisfaction through seamless <br />
                transactions and competitive product <br />
                pricing. We are updating and improving <br />
                our product selection at the best prices
                <br /> to delight our customers along with
                <br />
                catchy deals, flash sales, and other cool
                <br /> promos.
              </p>
              <p className="content">
                Sporting a new‘heart’ logo mark that <br />
                shows the letter “L” as a three-
                <br />
                dimensional box, Lazada is committing <br />
                to providing better and more unique
                <br /> ways to make sure that every transaction <br />
                is truly effortless. The new tagline ‘Go
                <br /> Where Your Heart Beats’ represents the <br />
                company’s vision to boost the online <br />
                shopper and seller experience through
                <br /> commerce and technology. The colorful
                <br />
                heart logo is a youthful, energetic look,
                <br /> that symbolizes the vibrancy of shopping
                <br /> and today’s digital age.
              </p>
              <p className="head-content">EASY SHOPPING</p>
              <p className="content">
                “Effortless shopping” has been our goal
                <br /> throughout the years, promising every
                <br /> customer with nothing but hassle-free,
                <br /> and convenient online shopping <br />
                experience. We have sorted everything to
                <br /> ease your search through our user-
                <br />
                friendly website and App. Products are
                <br /> listed under their respective
                <br />
                categories and descriptions as well as reviews are
                <br /> openly provided.
              </p>
              <p className="content">
                With LazMall, you won’t run out of
                <br /> options as we collaborated with <br />
                hundreds of top brands worldwide. There
              </p>
            </div>
            <div className="col-md-3">
              <p className="content">
                are more and more renowned sellers
                <br /> joining our community to serve you too.
                <br /> RedMart also offers a vast selection of
                <br /> grocery items at the lowest prices.
              </p>
              <p className="head-content">
                MULTIPLE PAYMENT <br /> OPTIONS
              </p>
              <p className="content">
                Transacting with us is easy as we accept
                <br /> multiple modes of payment. Being a<br /> leading online
                marketplace, we feel
                <br /> responsible to give you a safe and <br />
                secure platform to shop with. Our
                <br /> payment gateway keeps all your <br />
                sensitive information protected from
                <br />
                unauthorized users and any fraudulent
                <br />
                activities. You can pay through <br />
              ...
              <p className="content">
                We not only give you an excellent choice
                <br /> of products but also extend the luxury of
                <br /> nationwide home delivery. We ship
                <br />
                anything to your doorsteps anywhere <br />
                you are on the island. Received a<br />
                damaged shipment? Send it back
                <br /> through our hassle-free returns policy <br />
                and we will send a refund as soon as <br />
                possible.
              </p>
              <p className="head-content">
              ...
              <p className="content">
                Attractive deals can be purchased on the
                <br /> website daily. Discount codes and
                <br /> multiple vouchers can be redeemed to
                <br /> make the most of your shopping. Scoop
                <br /> up these incredible promo codes <br />
                especially during our campaign periods
                <br /> including Birthday Sale, Women’s Festival, Mid-Year
                Festival, 9.9 Sale and
                <br /> Lazada’s most anticipated online
                <br /> shopping festivals: 11.11 and 12.12
                <br /> Sales!
              </p>
            </div>
            <div className="col-md-3">
            ...
            <div className="col-md-3">
              ...
              <p className="content">
                ...
                , Coccinelle , Morgan , Timbuk2 ,<br /> Guess , Cath Kidston ,
                COACH , Jansport ,<br /> more...
              </p>
              <p className="content">
              ...
              <p className="mini-head">RECOMMEND PRODUCT</p>
            </div>
          </div>
        </div>
      </div>
